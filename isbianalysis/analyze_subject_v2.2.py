...
def process_subject(subj_id, csv_file_path, lock, framework_name, base_path, condition, output_dir):
    ...
    for hemi in hemispheres:
        ...
        for surf_type in surf_types:
            ...
            pred_surf_dir = os.path.join(base_path,condition,'test', surf_type, hemi)
            gt_surf_dir = os.path.join(base_path,condition,'test', f'{surf_type}_gt', hemi)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--condition', type=str, required=True, help='[a,b] represents the training methodology')
    ...
    lock = Lock()
    process_subject(subj_id, csv_file_path, lock, framework_name, base_path, condition, output_dir)
