...
python generateTestDiceAndSurfaces.py --model_file=$model_file --data_dir='/speedrun/cortexode-data-rp/' --model_dir='/cortexode/ckpts/hcp_vc_sym_gnn_0/model/' --result_dir='/cortexode/ckpts/hcp_vc_symtoassymindist_0/result/' --parc_init_dir='/cortexode/ckpts/hcp_vc_symtoassymindist_0/parc_init/' --model_type 'csrvc' --model_type2 'baseline' --patience 'standard' --visualize 'yes' --version $version --gnn $gnn --gnn_layers $gnn_layer --gat_heads $gat_head --train_type='surfvc' --data_name='hcp'  --surf_hemi='rh' --surf_type='gm' --n_samples=150000 --tag='vc' --device='gpu' 
