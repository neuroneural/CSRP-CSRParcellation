...
data_csv_path = '../csvs/fastsurfer_measures.csv'
...
# Filter out Dice with Label -1 and 4
df = df[~((df['Metric'] == 'Dice') & (df['Label'].isin([-1, 4])))]
...
output_csv = '../csvs/fastsurfer_summary.csv'
