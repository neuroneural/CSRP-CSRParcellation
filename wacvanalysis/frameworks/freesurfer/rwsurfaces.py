...
def process_subject(subject_dir, dest_dir, subject):
    ...
    surfaces = ['lh.pial', 'lh.pial.deformed', 'rh.pial', 'rh.pial.deformed', 
                'lh.white', 'lh.white.deformed', 'rh.white', 'rh.white.deformed']
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process FreeSurfer surfaces and convert to STL and FreeSurfer formats")
    parser.add_argument("--subject-dir", type=str, required=True, help="Path to FreeSurfer subjects directory")
