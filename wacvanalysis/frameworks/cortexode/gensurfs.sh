...
SEG_MODEL_DEST_PATH="./wacvanalysis/frameworks/cortexode/model/model_seg_hcp_Unet.pt"
...
RESULT_DIR_VERSION_0="/data/users2/washbee/wacv/surfaces/cortexode"

# Run the Python scripts with the specified parameters
python ./wacvanalysis/frameworks/generate_testsurfaces.py --gnn baseline --data_dir='/speedrun/cortexode-data-rp/' --data_name='hcp' --n_samples=150000 --tag='csrf' --device='gpu' --model_dir=$MODEL_DIR_V0 --segmentation_model_path $SEG_MODEL_DEST_PATH --model_file $DEF_MODEL_PATH_GM_LH_V0 --version 0 --surf_hemi lh --surf_type gm --step_size $STEP_SIZE --solver $SOLVER --result_dir $RESULT_DIR_VERSION_0
python ./wacvanalysis/frameworks/generate_testsurfaces.py --gnn baseline --data_dir='/speedrun/cortexode-data-rp/' --data_name='hcp' --n_samples=150000 --tag='csrf' --device='gpu' --model_dir=$MODEL_DIR_V0 --segmentation_model_path $SEG_MODEL_DEST_PATH --model_file $DEF_MODEL_PATH_GM_RH_V0 --version 0 --surf_hemi rh --surf_type gm --step_size $STEP_SIZE --solver $SOLVER --result_dir $RESULT_DIR_VERSION_0
python ./wacvanalysis/frameworks/generate_testsurfaces.py --gnn baseline --data_dir='/speedrun/cortexode-data-rp/' --data_name='hcp' --n_samples=150000 --tag='csrf' --device='gpu' --model_dir=$MODEL_DIR_V0 --segmentation_model_path $SEG_MODEL_DEST_PATH --model_file $DEF_MODEL_PATH_WM_LH_V0 --version 0 --surf_hemi lh --surf_type wm --step_size $STEP_SIZE --solver $SOLVER --result_dir $RESULT_DIR_VERSION_0
