...
python trainCSRandParcellationResume2.py \
    ...
    --model_file 'model_wm_hcp_rh_vc_v4_csrvc_layers8_sf0.1_heads1_310epochs_euler_norecon_class_de0.1_906499.pt' \
    --data_name 'hcp' \
    --surf_hemi 'rh' \
    --surf_type 'wm' \
    --n_epochs 401 \
    ...
    --dropedge_prob .1 \
    --parc_init_dir '/cortexode/ckpts/isbi/isbi_gnnv4_0/result/a/'
