...
python train_CSRSegmenter.py --model_type 'csrvc' --patience 'standard' --visualize 'yes' --version $version --gnn $gnn --gnn_layers $gnn_layer --gat_heads $gat_head --train_type='surfvc' --data_dir='/speedrun/cortexode-data-rp/' --model_dir='/cortexode/ckpts/exp_vc_gnn_0/model/' --data_name='hcp'  --surf_hemi='rh' --surf_type='gm' --n_epochs=1 --start_epoch=1 --n_samples=150000 --tag='vc' --device='gpu' 
