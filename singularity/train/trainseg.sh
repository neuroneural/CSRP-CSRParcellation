...
python train.py --seg_model_type='Unet' --train_type='seg' --data_dir='/speedrun/cortexode-data-rp/' --model_dir='./ckpts/hcp_csrf_gnn_0/model/' --data_name='hcp' --n_epoch=205 --tag='Unet' --device='gpu'
