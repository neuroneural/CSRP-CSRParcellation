...
python train.py --train_type='surf' --data_dir='/speedrun/csrf-data-dev/' --model_dir='/cortexode/ckpts/exp_csrf_gnn_1/model/' --init_dir='/cortexode/ckpts/exp_csrf_gnn_1/init/' --data_name='adni'  --surf_hemi='lh' --surf_type='gm' --n_epochs=1 --n_samples=150000 --tag='csrf' --solver='rk4' --step_size=0.1 --device='gpu' 
