...
case $gnn_layer in
    2)
        model_file="model_wm_hcp_rh_csrf_v3_gnngat_layers2_sf0.1_heads1_180epochs_euler.pt"
        start_epoch=181
        ;;
    3)
        model_file="model_wm_hcp_rh_csrf_v3_gnngat_layers3_sf0.1_heads1_150epochs_euler.pt"
        start_epoch=151
        ;;
    4)
        model_file="model_wm_hcp_rh_csrf_v3_gnngat_layers4_sf0.1_heads1_130epochs_euler.pt"
        start_epoch=131
        ;;
esac
