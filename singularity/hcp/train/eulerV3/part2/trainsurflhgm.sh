...
case $gnn_layer in
    2)
        model_file="model_gm_hcp_lh_csrf_v3_gnngat_layers2_sf0.1_heads1_200epochs_euler.pt"
        start_epoch=201
        ;;
    3)
        model_file="model_gm_hcp_lh_csrf_v3_gnngat_layers3_sf0.1_heads1_170epochs_euler.pt"
        start_epoch=171
        ;;
    4)
        model_file="model_gm_hcp_lh_csrf_v3_gnngat_layers4_sf0.1_heads1_140epochs_euler.pt"
        start_epoch=141
        ;;
esac
