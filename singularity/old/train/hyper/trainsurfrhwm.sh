...
python train.py --version $version --gnn $gnn --gnn_layers $gnn_layer --gat_heads $gat_head --train_type='surf' --data_dir='/speedrun/cortexode-data-rp/' --model_dir='/cortexode/ckpts/exp_csrf_gnn_2/model/' --init_dir='/cortexode/ckpts/exp_csrf_gnn_2/init/' --data_name='adni'  --surf_hemi='rh' --surf_type='wm' --n_epochs=30 --start_epoch=1 --n_samples=150000 --tag='csrf' --solver='rk4' --step_size=0.1 --device='gpu'
